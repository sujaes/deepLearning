...
# img = mpimg.imread("./Image/test_img_0.jpg")
img = mpimg.imread("C:/Users/memoming/DegreeProject/Github/Image4/test_img_0.jpg")

img = img.reshape(-1,28,28,1)

W1 = tf.Variable( tf.random_normal([3,3,1,5], stddev=0.01) )
conv2d = tf.nn.conv2d( img.astype(np.float32), W1, strides=[1,2,2,1], padding="SAME" )
