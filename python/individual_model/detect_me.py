...
def is_me_with_model ( img ) :
    with tf.Session() as sess:
        saver = tf.train.import_meta_graph("saved_model" + os.sep + "woojae_model.ckpt.meta")
...
if ( __name__ == "__main__" ) :
    ...
    faces = faceCascade.detectMultiScale(
        gray,
        scaleFactor=1.1, # 1.1 하며 26 , 1.01 하면 56
        minNeighbors=2,
        minSize=(30, 30)
    )
